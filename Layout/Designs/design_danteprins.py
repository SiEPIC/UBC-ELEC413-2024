...
def design_danteprins(cell, cell_y, inst_wg1, inst_wg2, inst_wg3, waveguide_type):
    ...
    # instantiate taper from 350 nm waveguide y-branch to 500 nm Bragg grating
    ...
    try:
        connect_pins_with_waveguide(inst_bragg1, 'opt2', inst_bragg2, 'opt2', waveguide_type=waveguide_type_mm, 
            turtle_A = [335,90,40,90,355,-90,120,-90,50,-90,100,90,50,90,100,-90,50,-90,100,90,50,90,100,-90,50,-90] )
    except:    
         connect_pins_with_waveguide(inst_bragg1, 'opt2', inst_bragg2, 'opt2', waveguide_type=waveguide_type_mm, 
            turtle_A = [320,90,40,90,360,-90,40,-90] )
