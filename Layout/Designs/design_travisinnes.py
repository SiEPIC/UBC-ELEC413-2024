...
def design_travisinnes(cell, cell_y, inst_wg1, inst_wg2, inst_wg3, waveguide_type):
    ...
    try:
        connect_pins_with_waveguide(inst_bragg1, 'opt2', inst_bragg2, 'opt2', 
            ...
            turtle_A = [320,90,20,90,335,-90,20,-90,300,90,20,90,300,-90,20,-90,220,90,20,90,220,-90,20,-90,220,90,20,90,220,-90,20,-90,340,-90,20,-90,95,90,20,90,95,-90,20,-90,95,90,20] )
    except:    
        connect_pins_with_waveguide(inst_bragg1, 'opt2', inst_bragg2, 'opt2', 
