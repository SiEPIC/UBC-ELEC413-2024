...
def design_arthurb(cell, cell_y, inst_wg1, inst_wg2, inst_wg3, waveguide_type):
    ...
    try:
        connect_pins_with_waveguide(inst_bragg1, 'opt2', inst_bragg2, 'opt2', 
            ...
            turtle_A = [125,90,20,90,125,-90,20,-90,125,90,20,90,125,-90,20,-90,125,90,20,90,125,-90,20,-90,125,90,20,90,125,-90,20,-90, 180, -90, 120, 90, 20, 90] )
    except:    
        connect_pins_with_waveguide(inst_bragg1, 'opt2', inst_bragg2, 'opt2', 
