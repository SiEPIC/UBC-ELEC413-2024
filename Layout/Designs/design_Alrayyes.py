...
def design_Alrayyes(cell, cell_y, inst_wg1, inst_wg2, inst_wg3, waveguide_type):
    ...
    try:
        connect_pins_with_waveguide(inst_bragg1, 'opt2', inst_bragg2, 'opt2', 
            waveguide_type='Strip TE 1310 nm, w=386 nm (core-clad)', 
            #turtle_A = [250,90,20,90,250,-90,20,-90,250,90,20,90,250,-90,20,-90] )
            turtle_A = [20,90,80,-90,20,-90,80,
                        90,20,90,80,-90,20,-90,80,
                        90,20,90,80,-90,20,-90,80,
                        90,20,90,80,-90,20,-90,80,
                        90,20,90,80,-90,20,-90,80,
                        90,20,90,100,90,220,90,80,
                        -90,30,-90,160,-90,250,-90,20,
                        -90,240,90,50,90,20,90,40,
                        -90,20,-90,40,90,20,90,40,
                        -90,20,-90,40,90,20,90,40,
                        -90,20,-90,40,90,20,90,40,
                        -90,20,-90,40,90,20,90,40,
                        -90,20,-90,40,90,20,90,40,
                        -90,20,-90,20,90,20,90,50,
                        -90,90,-90,20,-90,80,90,20,
                        90,80,-90,20,-90,100,90,20])
    except:    
        connect_pins_with_waveguide(inst_bragg1, 'opt2', inst_bragg2, 'opt2', 
