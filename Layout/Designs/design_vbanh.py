...
def design_vbanh(cell, cell_y, inst_wg1, inst_wg2, inst_wg3, waveguide_type):
    ...
    try:
        connect_pins_with_waveguide(inst_bragg1, 'opt2', inst_bragg2, 'opt2', 
            ...
            turtle_A = [325,90,20,90,345,-90,100,-90,285,-90,20,-90,265,90,60,90,265,90,20,90,245,-90,20,-90] )
    except:    
        connect_pins_with_waveguide(inst_bragg1, 'opt2', inst_bragg2, 'opt2', 
            waveguide_type='Strip TE 1310 nm, w=350 nm (core-clad)', 
