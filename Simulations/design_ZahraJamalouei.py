...
def design_ZahraJamalouei(cell, cell_y, inst_wg1, inst_wg2, inst_wg3, waveguide_type):
    ...
    try:
        connect_pins_with_waveguide(inst_bragg1, 'opt2', inst_bragg2, 'opt2', 
            ...
            turtle_A = [300,90,20,90,365,-90,20,-90,355,90,20,90,355,-90,120,-90,365,-90,20,-90,345,90,20,90,345,-90,20,-90,345,90,20,90] )
    except:    
        connect_pins_with_waveguide(inst_bragg1, 'opt2', inst_bragg2, 'opt2', 
